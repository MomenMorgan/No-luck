...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        """get returns a specific object or none"""
        newState = State(name="New York")
        newState.save()
        newUser = User(email="lollol@gmail.com", password="password")
        newUser.save()
        self.assertIs(newState, models.storage.get("State", newState.id))
        self.assertIs(None, models.storage.get("State", "dummy"))
        self.assertIs(None, models.storage.get("dummy", "dummy"))
    ...
    def test_count(self):
        ...
        newState.save()
        newUser = User(email="tomandjerry@gmail.com", password="dummypass")
        newUser.save()
